![BuildStatus](https://github.com/carolinehhuang/HW6-HMM/actions/workflows/ci.yml/badge.svg)

# HW6-HMM

This assignment was an implementation of the Hidden Markov Model, where the Forward and Viterbi Algorithms were implemented with dynamic programming. 
The forward algorithm initializes and fills a matrix with the probabilities of different sequence combinations of observation states. The Viterbi algorithm is then
used to backtrace through the matrix generated by the forward algorithm, identify the steps with the maximum probability of occurring, and return the sequence of 
hidden states that is most likely to have resulted in the observed sequence.
# Assignment
